...
namespace Lab_Assignment_3_2 {
    ...
    public partial class booksDataSet : global::System.Data.DataSet {
        ...
        public partial class TitlesDataTable : global::System.Data.TypedTableBase<TitlesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TitlesRow AddTitlesRow(string Title, short Year_Published, string ISBN, int PubID) {
...
namespace Lab_Assignment_3_2.booksDataSetTableAdapters {
    ...
    public partial class TitlesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Titles` WHERE (((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((" +
                "? = 1 AND `Year_Published` IS NULL) OR (`Year_Published` = ?)) AND (`ISBN` = ?) " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Titles` (`Title`, `Year_Published`, `ISBN`, `PubID`) VALUES (?, ?, ?" +
                ", ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Titles` SET `Title` = ?, `Year_Published` = ?, `ISBN` = ?, `PubID` = ? WHERE (((? = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND `Year_Published` IS NULL) OR (`Year_Published` = ?)) AND (`ISBN` = ?) AND ((? = 1 AND `PubID` IS NULL) OR (`PubID` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab_Assignment_3_2.Properties.Settings.Default.booksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Title, Year_Published, ISBN, PubID FROM Titles";
        ...
        public virtual int Delete(string Original_Title, global::System.Nullable<short> Original_Year_Published, string Original_ISBN, global::System.Nullable<int> Original_PubID) {
        ...
        public virtual int Insert(string Title, global::System.Nullable<short> Year_Published, string ISBN, global::System.Nullable<int> PubID) {
            if ((Title == null)) {
        ...
        public virtual int Update(string Title, global::System.Nullable<short> Year_Published, string ISBN, global::System.Nullable<int> PubID, string Original_Title, global::System.Nullable<short> Original_Year_Published, string Original_ISBN, global::System.Nullable<int> Original_PubID) {
            if ((Title == null)) {
            ...
            if ((Original_Year_Published.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((short)(Original_Year_Published.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, global::System.Nullable<short> Year_Published, global::System.Nullable<int> PubID, string Original_Title, global::System.Nullable<short> Original_Year_Published, string Original_ISBN, global::System.Nullable<int> Original_PubID) {
            return this.Update(Title, Year_Published, Original_ISBN, PubID, Original_Title, Original_Year_Published, Original_ISBN, Original_PubID);
        }
    }
